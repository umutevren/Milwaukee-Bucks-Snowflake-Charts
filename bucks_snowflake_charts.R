...
umutevren_theme <- function () { 
  theme_minimal(base_size=11, base_family="Courier") %+replace% 
    theme(
...
p <- ggplot() +
  ...
  annotate(geom = 'label', x = 0, y = 33.5, hjust = .5, label = "Bucks prefers restricted area to floaters", family = "Consolas", size = 3)
